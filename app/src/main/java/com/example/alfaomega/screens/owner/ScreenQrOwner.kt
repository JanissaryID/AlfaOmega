...
@Composable
fun ScreenQrOwner(navController: NavController, bluetoothViewModel: BluetoothViewModel, protoViewModel: ProtoViewModel) {

    val tittleScreen = stringResource(R.string.QrPayment)
